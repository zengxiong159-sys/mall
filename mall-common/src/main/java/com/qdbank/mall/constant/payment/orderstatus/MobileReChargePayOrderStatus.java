...
public enum MobileReChargePayOrderStatus implements OrderStatusAware {
    ...
    MobileReChargePayOrderStatus(Long[] status, Long closeType, Long refundStatus, boolean bsnFlag, String msg,MetricsHolder metricsHolder){
        this.status=status;
    ...
    public static MobileReChargePayOrderStatus getOrderStatus(Long status, Long closeType, Long refundStatus ){
        for(MobileReChargePayOrderStatus orderStatus : MobileReChargePayOrderStatus.values()){
