...
public enum OilOrderStatus implements OrderStatusAware {
    ...
    OilOrderStatus(Long[] status, Long closeType, Long refundStatus, boolean bsnFlag, String msg, MetricsHolder metricsHolder){
        this.status=status;
    ...
    public static OilOrderStatus getOrderStatus(Long status, Long closeType, Long refundStatus ){
        for(OilOrderStatus orderStatus : OilOrderStatus.values()){
