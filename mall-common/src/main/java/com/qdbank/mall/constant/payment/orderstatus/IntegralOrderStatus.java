...
public enum IntegralOrderStatus implements OrderStatusAware {
    ...
    PREPARE_USE(new Long[]{7L},CloseTypeEnum.INIT.closeType,com.qdbank.mall.constent.payment.RefundStatausEnum.INIT.refundStatus,true,"待使用",null),
    HAS_FINISH(new Long[]{8L},CloseTypeEnum.INIT.closeType,com.qdbank.mall.constent.payment.RefundStatausEnum.INIT.refundStatus,true,"已使用",null),
    ...
    EXPIRE(new Long[]{5L},CloseTypeEnum.INIT.closeType,com.qdbank.mall.constent.payment.RefundStatausEnum.INIT.refundStatus,true,"失效",null),
    ;
    ...
    IntegralOrderStatus(Long[] status, Long closeType,Long refundStatus,boolean bsnFlag,String msg, MetricsHolder metricsHolder){
        this.status=status;
    ...
    public static IntegralOrderStatus  getOrderStatus(Long status,Long closeType,Long refundStatus ){
        for(IntegralOrderStatus orderStatus : IntegralOrderStatus.values()){
