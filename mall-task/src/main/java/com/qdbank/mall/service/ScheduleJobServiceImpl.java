...
import com.qdbank.mall.mapper.ScheduleJobMapper;
import com.qdbank.mall.model.ScheduleJobEntity;
import com.qdbank.mall.utils.Constant;
import com.qdbank.mall.utils.PageUtils;
import com.qdbank.mall.utils.Query;
import com.qdbank.mall.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobMapper, ScheduleJobEntity> implements ScheduleJobService {
	...
	public void saveJob(ScheduleJobEntity scheduleJob) {
		...
		scheduleJob.setJobId(Long.valueOf(new SimpleDateFormat("yyyyMMddHHmmss").format(new Date())));
