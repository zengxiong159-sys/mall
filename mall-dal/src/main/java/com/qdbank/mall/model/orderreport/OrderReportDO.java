...
public class OrderReportDO implements Serializable {
    /**
     * 订单主键 
     *
     * @mbg.generated
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "订单实付款(折算价):包含运费+积分折算人民币价格")
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "订单状态：(根据商品类型区分）实物订单：0待支付 1待发货 2已发货 4已关闭 话费订单：0待支付1充值中3已完成4已关闭积分券兑换订单：0待支付2待使用3已使用4已关闭5已过期")
    private Long status;
